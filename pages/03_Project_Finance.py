...
with tabs[7]:
    ...
    st.caption("Implementação preservada no histórico do git (commit 9b1d816). Será reativada na próxima fase.")

with tabs[8]:
    st.markdown("### 🔒  Contract Minutes")
    st.info("🚧  **Em breve / Coming soon** — funcionalidade em desenvolvimento, será liberada após o MVP.")
    st.caption("Gerador de minutas (16 cláusulas Facility Agreement, Common Terms, Intercreditor, etc.) preservado no histórico do git. Será reativado na próxima fase.")
